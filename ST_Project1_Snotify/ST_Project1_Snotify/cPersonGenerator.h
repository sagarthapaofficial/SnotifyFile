...
public:
	...
	cSmartArrayVector<std::string>vecfirstName;
	cSmartArrayVector<std::string>SurnameVec;
	cSmartArrayVector<std::string>streetNameVec;
	cSmartArrayVector<std::string>streetTypeVec;
	cSmartArrayVector<std::string>DirectionVec;
